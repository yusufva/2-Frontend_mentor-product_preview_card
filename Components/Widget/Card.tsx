...
export default function Card() {
  return (
    ...
    <div className=' w-[640px] bg-white grit-cols-4 gap-0 rounded-lg'>
        <div className=' flex-auto columns-2 '>
            <aside>
                <img src='image-product-desktop.jpg' className='  rounded-l-lg ' alt='Gabrielle Essence Eau De Parfum' />
            </aside>
            <div className='grid-rows-4 gap-0 mx-4 w-[272px]'>
              <br />
                <article>
                    <h3 className=' font-montserrat font-medium text-base mt-3 text-[#6c7289] '>P E R F U M E</h3>
                    <h1 className=' font-fraunces font-bold text-4xl mt-5'>Gabrielle Essence Eau De Parfum</h1>
                ...
                <button className=' btn btn-darkCyan w-64 mt-4 rounded-5xl inline-flex items-center justify-center '>
